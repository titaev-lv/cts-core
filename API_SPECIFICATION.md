...
> **Статус**: Целевая спецификация + Phase 2 runtime baseline + Phase 1.5 metrics baseline реализованы  
...
- Реализовано: REST `/metrics` c Prometheus wiring и runtime metrics сериями (`cts_core_*`).
