	...
	response := gin.H{
		...
		"components": gin.H{
			...
			"scheduler": gin.H{
				...
				"last_assign_status":   runtimeSnapshot.SchedulerLastAssignStatus,
				"assign_latency_ms":    runtimeSnapshot.SchedulerAssignLatencyMs,
				"score_p50":            runtimeSnapshot.SchedulerScoreP50,
				"score_p95":            runtimeSnapshot.SchedulerScoreP95,
				"assign_attempts":      runtimeSnapshot.SchedulerAssignAttempts,
				"resource_rejections":  runtimeSnapshot.SchedulerResourceRejections,
